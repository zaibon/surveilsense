module github.com/zaibon/surveilsense
...
require (
	...
	github.com/tochemey/goakt-examples/v2 v2.0.0-20250613214639-019a0a2ad637 // indirect
	github.com/tochemey/goakt/v3 v3.6.3 // indirect
